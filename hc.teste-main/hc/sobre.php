...
<html lang="pt-BR">
  <head>
    ...
    <title>Lucyan // Portifólio</title>
  </head>
  <body>
    <nav id="navigation">
      <div class="wrapper">
        <a class="logo close" href="#home"> lucyanovidio </a>

        <div class="menu">
          <ul>
            <li>
              <a id="aboutNav" class="close" href="#about">Sobre mim</a>
            </li>
            <li>
              <a id="projectsNav" class="close" href="#projects">Projetos</a>
            </li>
            <li>
              <a id="knowledgeNav" class="close" href="#knowledge"
                >Conhecimentos</a
              >
            </li>
            <li>
              <a id="contactNav" class="close" href="#contact">Fale comigo</a>
            </li>
          </ul>
    ...
    <section id="home">
      <div class="wrapper">
        <div class="col-a">
          ...
          <div class="content">
            <p class="line typing">Desenvolvedor Web Front-end.</p>
            <a class="button" href="#contact"> Fale comigo </a>
          </div>
        </div>
        ...
        <div class="col-b">
          ...
          <img
            ...
            alt="Imagem de um notebook com tela quebrada"
            id="notebook-2"
          />
          <img
    ...
    <footer>
      <div class="wrapper">
        <div class="col-a">
          <a class="logo" href="#home"> lucyanovidio </a>
